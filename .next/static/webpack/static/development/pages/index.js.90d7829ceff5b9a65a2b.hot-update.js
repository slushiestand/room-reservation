...
})(["display:flex;flex-direction:column;margin-left:20px;background-color:#E7E7E7;font-family:Arial;border-radius:10px;width:150px;"]);
...
})(["display:flex;flex-direction:row;align-items:center;background-color:#FFFFFF;justify-content:space-between;border-radius:10px;"]);
...
})(["background-color:#FFFFFF;flex-direction:column;text-align:center;font-size:15px;padding:15px 7.5px 15px 15px;"]);
...
})(["background-color:#FFFFFF;flex-direction:column;text-align:center;font-size:15px;padding:15px 15px 15px 7.5px;"]);
...
//# sourceMappingURL=index.js.90d7829ceff5b9a65a2b.hot-update.js.map