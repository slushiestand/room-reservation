...
})(["display:flex;flex-direction:row;align-items:center;justify-content:center;background-color:{this.props.checked}=== true:#FFFFFF ? grey;border-radius:10px;padding:2px;"]);
...
})(["background-color:{this.props.checked}=== true:#FFFFFF ? grey;flex-direction:column;text-align:center;font-size:12px;padding:10px 5px 10px 10px;"]);
...
})(["background-color:{this.props.checked}=== true:#FFFFFF ? grey;flex-direction:column;text-align:center;font-size:12px;padding:10px 10px 10px 5px;"]);
...
//# sourceMappingURL=index.js.6ead22846051505d6c27.hot-update.js.map