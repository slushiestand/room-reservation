...
})(["background-color:", ";flex-direction:column;text-align:center;font-size:12px;padding:0px 5px 10px 10px;"], function (props) {
  return props.checked == true ? '#FFFFFF' : '#DBDBE3';
});
...
})(["background-color:", ";flex-direction:column;text-align:center;font-size:12px;padding:0px 10px 10px 5px;"], function (props) {
  return props.checked == true ? '#FFFFFF' : '#DBDBE3';
});
...
//# sourceMappingURL=index.js.7b59116de4ae28664356.hot-update.js.map