...
})(["display:flex;flex-direction:column;margin-left:20px;background-color:", ";font-family:Arial;padding:5px;border-radius:10px;height:100px;"], function (props) {
...
})(["color:", ";text-align:left;font-weight:bold;font-size:15px;"], function (props) {
...
})(["background-color:", ";color:", ";flex-direction:column;text-align:center;font-size:12px;padding:10px 5px 10px 10px;"], function (props) {
  return props.checked == true ? '#FFFFFF' : '#DBDBE3';
}, function (props) {
  return props.checked == true ? '#292929' : '#44454A';
});
...
//# sourceMappingURL=index.js.3711916c9c6e9b546174.hot-update.js.map