...
})(["border:0;clip:rect(0 0 0 0);clippath:inset(50%);height:1px;margin:-1px;overflow:hidden;padding:0;white-space:nowrap;width:1px;"]);
...
})(["width:16px;height:16px;background:", " border-radius:3px;transition:all 150ms;", ":focus + &{box-shadow:0 0 0 3px pink;}", "{visibility:", "}"], function (props) {
...
//# sourceMappingURL=index.js.f59b75a3aa96910a4786.hot-update.js.map